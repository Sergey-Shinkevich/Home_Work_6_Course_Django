...
class ProductForm(forms.ModelForm):
    ...
    def _validate_forbidden_words(self, value):
        ...
        for word in FORBIDDEN_WORDS:
            if word in value_lower:
                raise forms.ValidationError(f"Использование слова или части слова «{word}» запрещено.")
        return value
    ...
    def clean_description(self):
        return self._validate_forbidden_words(self.cleaned_data.get("description"))
